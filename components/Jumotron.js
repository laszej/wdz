    ...
    <div className="jumotron">
      <div className="jumbotron jumbotron-fluid" id="jumbotron">
        <div className="container">
          ...
          <p className="lead">    Witamy wszystkich serdecznie na naszej stronie! Jesteśmy grupą 9 z 15-tu radnych Osiedla Nowe Winogrady Północ. Reprezentujemy również Zarząd Osiedla. Na tej stronie: </p>
