      ...
      <div className={styles.projectsContainer}>
        <div className={`${styles.projectsWrapper} ${isVisible[0] ? styles["is-visible"] : ""}`} ref={refs[0]}>
          <div className={styles.projects}>
            <strong>Kruk Maria Halina</strong>
            <p>radna Rady Osiedla Nowe Winogrady Północ<br></br> <b>Wiceprzewodnicząca Rady</b></p>
        ...
        <div className={`${styles.projectsWrapper} ${isVisible[1] ? styles["is-visible"] : ""}`} ref={refs[1]}>
          <div className={styles.projects}>
            <strong>Laskowski Stanisław Tadeusz</strong>
        ...
        <div className={`${styles.projectsWrapper} ${isVisible[4] ? styles["is-visible"] : ""}`} ref={refs[4]}>
          <div className={styles.projects}>
            ...
            <p>radny Rady Osiedla Nowe Winogrady Północ<br></br> <b>Przewodniczący Zarządu Osiedla</b></p>
        ...
        <div className={`${styles.projectsWrapper} ${isVisible[5] ? styles["is-visible"] : ""}`} ref={refs[5]}>
          <div className={styles.projects}>
            ...
            <p>radny Rady Osiedla Nowe Winogrady Północ<br></br> <b>Wiceprzewodniczący Zarządu Osiedla</b></p>
        ...
        <div className={`${styles.projectsWrapper} ${isVisible[7] ? styles["is-visible"] : ""}`} ref={refs[7]}>
          <div className={styles.projects}>
            ...
            <p>radny Rady Osiedla Nowe Winogrady Północ<br></br> <b>Przewodniczący Rady</b></p>
        ...
        <div className={`${styles.projectsWrapper} ${isVisible[8] ? styles["is-visible"] : ""}`} ref={refs[8]}>
          <div className={styles.projects}>
            ...
            <p>radna Rady Osiedla Nowe Winogrady Północ<br></br> <b>Wiceprzewodnicząca Zarządu Osiedla</b></p>
            <img src="/projects/wielgosz.PNG" className={styles.pImages} />
          </div>
        </div>

        <div className={`${styles.projectsWrapper} ${isVisible[9] ? styles["is-visible"] : ""}`} ref={refs[9]}>
          <div className={styles.projects}>
